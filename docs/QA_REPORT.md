...
## 2026-09-20 카테고리/온라인 요청
단위/DB 28개 통과. 관련 E2E 6개(community 2, popular 1, regions 2, request-categories 1) 통과. 기존 테스트 기대 문구와 누적 fixture 선택자를 수정 후 해당 3개 재실행 통과. 새 요청의 주소 생략, 온라인/지역 분리, 수정 시 모드 유지, 새로고침 필터 유지 및 1440/390 가로넘침 검증. 원격 서비스 실연결은 미검증.
