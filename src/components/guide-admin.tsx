  ...
  return (
    <section className="panel guide-admin">
      ...
      <p className="muted small">
        자동 모드는 매일 오전 9시(한국 시간)에 실행되며, 실행 결과는 최근 생성
        기록에서 확인할 수 있습니다. 계약·법률·금액·안전 관련 표현이 감지된
        글은 검토할 수 있도록 초안으로 저장합니다. 자동 분류는 사실 검증을
        대신하지 않습니다. 설정 변경은 이후 생성되는 글에 적용되며, 아래 수동
        버튼은 항상 초안만 만듭니다.
      </p>
