...
export const categoryExamples: Record<string, string> = {
  ...
  "산업안전·보건": "안전관리 대행 상담, 사업장 점검·보건 업무",
  "전기·에너지": "전기안전관리 대행, 사업장 전기 설비 관리",
  "소방·방재": "소방시설 점검·유지관리 업체",
  "시설·건물관리": "승강기 유지보수, 건물·시설 관리 업체",
  "환경·폐기물": "사업장 환경관리, 폐기물 처리 업체",
  "검사·인증·품질": "비파괴검사, 제품 검사·인증 상담",
  "IT·기업운영": "사내 시스템, IT 운영·유지관리",
  "경영지원·전문대행": "사업 운영에 필요한 전문 업무 대행",
  기타: "분류에 없는 맡기고 싶은 일",
};
